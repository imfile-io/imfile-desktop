export default {
  ...
  'update-error-dns': '无法解析更新服务器地址，请检查网络连接与 DNS 设置。',
  'update-error-offline': '当前网络不可用，请检查是否已连接互联网。',
  'update-error-timeout': '连接更新服务器超时，请稍后重试。',
  'update-error-connection': '无法连接到更新服务器，请检查防火墙或代理设置。',

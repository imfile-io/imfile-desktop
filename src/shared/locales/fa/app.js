export default {
  ...
  'update-error-checksum':
    'فایل به‌روزرسانی تأیید نشد. دانلود ممکن است ناقص یا آسیب‌دیده باشد. بعداً دوباره بررسی به‌روزرسانی را امتحان کنید.',
  'update-error-unknown':
    'بررسی به‌روزرسانی ممکن نیست. اگر ادامه دارد، شبکه را بررسی کنید یا بعداً تلاش کنید.',
  'update-error-dismiss': 'بستن',
  'open-github-releases': 'باز کردن انتشارهای GitHub',
